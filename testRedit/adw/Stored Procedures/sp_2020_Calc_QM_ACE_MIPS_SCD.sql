...
-- =============================================
CREATE PROCEDURE [adw].[sp_2020_Calc_QM_ACE_MIPS_SCD] 
...
BEGIN TRAN
	...
	----DECLARE @qmdate date ='2022-01-15'	
	----DECLARE @MbrEffectiveDate DATE = '2022-01-01'
			--Declare Variables
	DECLARE @Metric				Varchar(20)		= 'ACE_MIPS_SCD'
	...
	JOIN			[adw].[2020_tvf_Get_ClaimsByValueSet]('ACE_MIPS_SCD_Encounter','','','',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffective)b
	...
	SELECT DISTINCT a.Subscriber_ID
	FROM			adw.[2020_tvf_Get_ClaimsByValueSet]('ACE_MIPS_SCD_DENEX',''
							,'ACE_MIPS_Depression','ACE_MIPS_Bipolar',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffective)a
	...
	FROM			 [adw].[2020_tvf_Get_ClaimsByValueSet]('ACE_MIPS_SCD_Screening)',''
					 ,'','ACO_DepressionScreening',@PrimSvcDate_Start,@PrimSvcDate_End,@CodeSetEffective) a 
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_ACE_MIPS_SCD] 	 @ConnectionStringProd	= '[adw].[QM_ResultByMember_History]',
											 @QMDATE				= '2022-01-15',
