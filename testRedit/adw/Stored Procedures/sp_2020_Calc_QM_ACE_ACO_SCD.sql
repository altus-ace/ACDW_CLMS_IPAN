...
-- =============================================
CREATE PROCEDURE [adw].[sp_2020_Calc_QM_ACE_ACO_SCD] 
...
BEGIN TRAN
	...
	--DECLARE @MbrEffectiveDate DATE = '2021-07-01'	
			--Declare Variables
	DECLARE @Metric				Varchar(20)		= 'ACE_ACO_SCD'
	...
	FROM			 [adw].[2020_tvf_Get_ClaimsByValueSet]('ACO_DepressionScreening',''
...
/***
Usage: 
EXEC [adw].[sp_2020_Calc_QM_ACE_ACO_SCD]	 @ConnectionStringProd	= '[adw].[QM_ResultByMember_History]',
											 @QMDATE				= '2021-07-15',
